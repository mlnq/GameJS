var config = {
  ...
  function preload() {
    ...
    this.load.audio('blaster','audio/SoundEffects/blaster.mp3');
  }
  
  var ball, paddle, cursors, bricks, gameoverText, sound;
  ...
  function create() {
    ...
    //dodanie dźwięków do menagera odtwarzania dźwięków
    sound = this.sound.add('blaster');
  }
